...
class T(unittest.TestCase):
    ...
    def test_t(self):
        ...
        Select(driver.find_element_by_id("id_chapter_dd")).select_by_visible_text("Chapter 2")
        Select(driver.find_element_by_id("id_right_lang_dd")).select_by_visible_text("Hebrew")
        driver.find_element_by_css_selector("input[type=\"submit\"]").click()
        Select(driver.find_element_by_id("id_left_lang_dd")).select_by_visible_text("Spanish")
        Select(driver.find_element_by_id("id_right_lang_dd")).select_by_visible_text("Russian")
        driver.find_element_by_css_selector("input[type=\"submit\"]").click()
        driver.find_element_by_link_text("Parallel Text").click()
