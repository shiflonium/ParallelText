...
pylint ../../books/*.py ../../content_mgmt/*py > MITCHELL_LINT
pylint ../../books/*.py ../../content_mgmt/*py  ../../manage.py ../../home/*py ../../pt_main/*py  ../../ptext/*py  ../../parallel_display/*py  ../../users/*.py  > GLOBAL_LINT
rm *LINT~
