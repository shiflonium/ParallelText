...
class Register(unittest.TestCase):
    ...
    def test_register(self):
        driver = self.driver
        driver.get(self.base_url + "/parallel_display/")
        driver.find_element_by_link_text("Parallel Text").click()
        driver.find_element_by_link_text("Register").click()
        driver.find_element_by_id("id_username").clear()
        driver.find_element_by_id("id_username").send_keys("emdad")
        driver.find_element_by_id("id_password1").clear()
        driver.find_element_by_id("id_password1").send_keys("emdad")
        driver.find_element_by_id("id_password2").clear()
        driver.find_element_by_id("id_password2").send_keys("emdad")
