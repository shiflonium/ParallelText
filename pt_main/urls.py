...
urlpatterns = patterns('',
    ...
    url(r'^parallel_display/', 'parallel_display.views.selectBook'),
    #url(r'^parallel_display/', 'parallel_display.views.selectLang'),
    #url(r'^parallel_display/(?P<book_from_form>[-\w]+)/$', 'parallel_display.views.selectLang', name='selectLang'),
    #url(r'^parallel_display/bbb/', 'parallel_display.views.selectLang'),
